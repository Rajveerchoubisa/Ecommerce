...
import BannerImg from "../../assets/website/banner1.jpg";
      ...
      <div className='container'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
            ...
            <div className='flex flex-col justify-between'>
              ...
              <p data-aos = "fade-up" className='text-sm text-gray-500 tracking-wide leading-5 py-4'>
              Embrace the season with our Winter Sale! Enjoy up to 50% off on a wide range of products. Don't miss out on incredible deals to keep you warm and stylish this winter. Shop now and save big!
              </p>
